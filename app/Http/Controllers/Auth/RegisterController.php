    ...
    */
    ...
    protected function create(array $data)
    {
        return User::create([
            ...
            'image'             => isset($request['image']) ? uploadImage($request['image']) : 'user.png',  // Image de profil, soit téléchargée via la fonction 'uploadImage' si présente, sinon image par défaut 'user.png'.  
